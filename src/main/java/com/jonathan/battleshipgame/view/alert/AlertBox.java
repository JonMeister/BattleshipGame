package com.jonathan.battleshipgame.view.alert;
...
public class AlertBox implements IAlertBox {
    ...
    public void showError(String title, String header, String content) {
        ...
        stage.getIcons().add(new Image(String.valueOf(getClass().getResource("/com/jonathan/batttleshipgame/images/battleship_icon.png")))); // To add an icon
        alert.showAndWait();
    }
    /**
